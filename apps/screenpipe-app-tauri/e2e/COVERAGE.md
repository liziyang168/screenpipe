...
| brain-overview.spec.ts | windows, macos, linux | real-ui-e2e, local-api, pipes | brain, brain-overview, artifacts, pipes | high | strong | real-user-flow | 1 | Creates a typed Brain overview, submits all supported component payloads with evidence, renders them in the real app, and captures the PR screenshot. |
